<?php get_header();/*Template Name: advertistment */ ?>
<div class="image_mkks">
  <?php
  $imageID = cs_get_option('singletitle');
...
<div class="main-breummkks">
  <div class="container breadcrum-mkks">
    <ol class="breadcrumb breadcrumb-arrow">
      <li><a href="single.php"> Top</a></li>
      <li><a href="single.php">Catalog</a></li>
      <li><a href="single.php">Automobiles</a></li>
  ...
  <div class="container">
    ...
    ?>
      ...
      <div class="col-lg-6 col-md-6 col-sm-6 wow fadeInUp" data-wow-delay="0.4s">
        ...
        <div class="single-advermkks">
         
          <img src="<?php the_post_thumbnail_url(); ?>"  class="img-responsive" alt="adver" />
          
          <div class="caption">
          <?php
          $meta_data = get_post_meta( get_the_ID(), 'custom_post_options', true );
          ?>
            <h3><a href="<?php the_permalink();?>"><span style="color:teal;font-weight: bold;"></span></a></h3>
            <p class="card-description"><b>Company </b> :<?php echo $meta_data['company'];?></p>
            <p class="card-description"><b>Brand </b> : <?php the_title();?></p>
            <p class="card-description"><b> publishdate</b> : <span><?php echo $meta_data['publishdate'];?></span></p>
            <p class="card-description"><b>source</b> : <span><?php echo $meta_data['source'];?></span></p>
            <p class="card-description"><b>size in cc</b> : <span><?php echo $meta_data['size'];?></span></p>
            <p class="descriptions"><b>Descriptions</b>:<span><?php echo $meta_data['description'];?></span></p>
              <p class="descriptions"><b>page no</b>:<span><?php echo $meta_data['page'];?></span></p>
